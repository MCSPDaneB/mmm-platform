...
def show():
    ...
    if clients:
        ...
        st.session_state.combined_analysis_client_filter = widget_value

        def on_combined_client_change():
            val = st.session_state.combined_analysis_client_filter
        ...
        selected_client = st.selectbox(
            ...
            on_change=on_combined_client_change,
